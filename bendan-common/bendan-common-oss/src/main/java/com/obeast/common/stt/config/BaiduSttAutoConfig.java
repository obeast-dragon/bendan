...
public class BaiduSttAutoConfig {
     ...
     */
    @Bean
    public AipSpeech aipSpeech(ThirdPartyBaiduSttProperties baiduAtProperties) {
        return new AipSpeech(baiduAtProperties.getAppId(), baiduAtProperties.getApiKey(), baiduAtProperties.getSecretKey());
    }
     ...
     * @author wxl
     * Date: 2023/1/5 9:35
     * @param aipSpeech aipSpeech
     * @return com.obeast.common.stt.template.BaiduSttTemplate
     */
    @Bean
    public BaiduSttTemplate  BaiduSttTemplate(AipSpeech aipSpeech) {
        return new BaiduSttTemplate(aipSpeech);
    }
