...
public class MinioOssTemplate {
     ...
     * MinIO 配置类
     */
    private final ThirdPartyMinioProperties minioProperties;
     ...
     * @return com.obeast.common.oss.domain.MinioTemplateResult
     */
    @SneakyThrows
    public MinioResult createDir(String dirName, String bucketName){
        minioClient.putObject(
                PutObjectArgs.builder()
                        ...
                        .object(dirName + "/")
                        .build());
        return new MinioResult(dirName, null);
    }
     ...
     */
    @SneakyThrows
    public MinioResult putSimpleObject(InputStream inputStream, String bucketName, String originalFileName) {
        try {
            ...
            return new MinioResult(originalFileName, originalFileName);
        } finally {
            if (inputStream != null) {
                inputStream.close();
            }
     ...
     */
    @SneakyThrows
    public MinioResult putObject(InputStream inputStream, String bucketName, String originalFileName) {
        ...
        try {
            ...
            return new MinioResult(uuidFileName, originalFileName);
        } finally {
            if (inputStream != null) {
                inputStream.close();
            }
     ...
     */
    @SneakyThrows
    public MinioResult putChunkObject(InputStream inputStream, String bucketName, String objectName) {
        try {
            minioClient.putObject(
                    PutObjectArgs.builder()
                            .bucket(bucketName)
                            ...
                            .stream(inputStream, inputStream.available(), -1)
                            .build());
            return new MinioResult(objectName, objectName);
        } finally {
            if (inputStream != null) {
                inputStream.close();
            }
     ...
     */
    @SneakyThrows
    public MinioResult composeObject(String bucketName, String fileName, List<ComposeSource> sourceObjectList) {
        ...
        return new MinioResult(presignedObjectUrl, fileName);
    }
     ...
     */
    @SneakyThrows
    public MinioResult composeObject(List<ComposeSource> sourceObjectList, String bucketName, String objectName) {
        minioClient.composeObject(ComposeObjectArgs.builder()
                .bucket(bucketName)
                .object(objectName)
                .sources(sourceObjectList)
        ...
        return new MinioResult(presignedObjectUrl, objectName);
    }
     ...
     */
    @SneakyThrows
    public MinioResult composeObject(String originBucketName, String targetBucketName, String objectName) {
