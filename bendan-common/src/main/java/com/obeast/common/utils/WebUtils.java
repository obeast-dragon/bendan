...
public class WebUtils extends org.springframework.web.util.WebUtils {
	...
	private static String[] splitClient(String header) {
		if (header == null || !header.startsWith(BASIC_)) {
			throw new BendanException("请求头中client信息为空");
		}
		...
		try {
			...
			throw new BendanException("Failed to decode basic authentication token");
		}
		...
		if (delim == -1) {
			throw new BendanException("Invalid basic authentication token");
		}
