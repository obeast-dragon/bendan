...
//             注册成功返回用户信息
     ...
     */
    @Override
    public void sendResMapToOneClient(String clientId, FlyweightRes flyweightRes) {
     ...
     **/
    private void sendResMapToClientByClientId(String clientId, FlyweightRes flyweightRes, SseEmitter sseEmitter) {
        if (sseEmitter == null) {
