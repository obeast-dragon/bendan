...
public class UserInfoController {
    ...
    public Map<String, Map<String, Map<String, Boolean>>> buttons() {
        Map<String, Map<String, Boolean>> map = new HashMap<>();
        map.put("useHooks", Map.of("add", true, "edit", true));
        Map<String, Map<String, Map<String, Boolean>>> res = new HashMap<>();
        res.put("data", map);
        return res;
    }

    @PostMapping("/login")
    public Map<String, Map<String, String>> login(String username, String password){
        System.out.println(username + "\n" + password + "\n" +"success!");
        Map<String, String> map = new HashMap<>();
        map.put("access_token", "unufvdotdqxuzfbdygovfmsbftlvbn");
