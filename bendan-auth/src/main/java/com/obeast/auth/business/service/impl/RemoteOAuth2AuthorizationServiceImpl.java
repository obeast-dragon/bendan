...
//
//import com.obeast.auth.business.service.BendanOAuth2AuthorizationService;
...
//    @Resource
//    private BendanOAuth2AuthorizationService oAuth2AuthorizationService;
//    @Override
...
//        oAuth2AuthorizationService.updateById(oAuth2AuthorizationConvertor.from(authorization));
//    }
//
//    private void insertAuthorization(OAuth2Authorization authorization) {
//        oAuth2AuthorizationService.save(oAuth2AuthorizationConvertor.from(authorization));
//    }
//
//    @Override
...
//        return Optional.ofNullable(oAuth2AuthorizationService.getById(id)).map(a -> oAuth2AuthorizationConvertor.to(a)).orElse(null);
//    }
//
//    @Override
